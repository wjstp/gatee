...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/52b78a08-f72a-4a60-b585-366167d9be5e/4348847c-0111-4017-be9e-ef6ccf65fc6a/Untitled.png)
...
### 3. 한마디 하기 - 메인에서 한마디 보내고 보낸 알림 받기
...
- **푸시 알림 발송**
    ...
    사용자 기기에 부여되는 고유한 토큰을 활용하여 알림을 발송합니다. 일정 등록, 사진 등록, 한마디 보내기, 채팅 서비스를 사용할때 서비스와 관련된 정보를 데이터 페이로드에 추가히여 푸시 알림 수신받은 사용자의 추후 동작을 처리할 수 있습니다.
...
- **다양한 종류의 알림 저장 및 조회**
    ...
    서비스 중 발생하는 다양한 푸시 알림의 비정형된 데이터를 저장합니다. 한마디보내기, 일정 등록, 사진 등록 서비스 이용시 서비스에 따라 다른 형식의 알림을 관리하기 위하여 적용하였습니다.  
